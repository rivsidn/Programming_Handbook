...
* [python](python/README.md)
  * [python基础](python/README.md)
    ...
    * [python布尔值](python/python布尔值.md)
    * [python字符串](python/python字符串.md)
    * [python列表](python/python列表.md)
    * [python元组](python/python元组.md)
    * [python集合](python/python集合.md)
    * [python字典](python/python字典.md)
    ...
    * [python作用域](python/python作用域.md)
    * [python模块](python/python模块.md)
    * [python模块管理](python/python模块管理.md)
    * [python异常处理](python/python异常处理.md)
    * [python帮助文档](python/python帮助文档.md)
